...
ca-certificates gnupg apt-transport-https software-properties-common apache2-utils
...
sudo rm -f "$BIN_DIR/dockerd" "$BIN_DIR/rootlesskit" "$BIN_DIR/docker"* 
sudo rm -rf "/run/user/$USER_ID/docker"*
