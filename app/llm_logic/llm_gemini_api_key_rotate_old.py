...
from redis_cache_configs.redis_lifespan_configs import(
    gemini_free_fast_api_manager_1,
    gemini_free_pro_api_manager_1,
    gemini_paid_fast_api_manager_1,
    gemini_paid_pro_api_manager_1,
)
...
class GeminiFreeFastRedisRotatingAPIKeyManagerSync:
    def __init__(
        ...
        rpm_limit: int = settings.GEMINI_FREE_3_FAST_RATELIMITS_RPM, 
        rpd_limit: int = settings.GEMINI_FREE_3_FAST_RATELIMITS_RPD, 
        tpd_limit: int = settings.GEMINI_FREE_3_FAST_RATELIMITS_TPM*settings.DAILY_MINUTES,
    ...
    async def initialize(self):
        ...
        self.conn = await genai.Client(api_key=initial_key)
        ...
        async with self._lock:
            for _ in range(len(self.api_keys)):
                ...
                if (current_rpm < self.rpm_limit and 
                    ...
                    pipe.expire(r_keys["rpm"], settings.DAILY_MINUTES)
                    pipe.expire(r_keys["rpd"], settings.DAILY_MINUTES)
                    pipe.expire(r_keys["tpd"], settings.DAILY_MINUTES)
...
class GeminiFreeProRedisRotatingAPIKeyManagerSync:
    def __init__(
        ...
        redis_url: str=settings.REDIS_URL_1,
        api_keys: List[str] = settings.gemini_api_keys, 
        rpm_limit: int = settings.GEMINI_FREE_3_PRO_RATELIMITS_RPM, 
        rpd_limit: int = settings.GEMINI_FREE_3_PRO_RATELIMITS_RPD, 
        tpd_limit: int = settings.GEMINI_FREE_3_PRO_RATELIMITS_TPM*settings.DAILY_MINUTES,
...
class GeminiPaidFastRedisRotatingAPIKeyManagerSync:
    def __init__(
        ...
        redis_url: str=settings.REDIS_URL_1,
        api_keys: List[str] = settings.gemini_api_keys, 
        rpm_limit: int = settings.GEMINI_PAID_3_FAST_RATELIMITS_RPM, 
        rpd_limit: int = settings.GEMINI_PAID_3_FAST_RATELIMITS_RPD, 
        tpd_limit: int = settings.GEMINI_PAID_3_FAST_RATELIMITS_TPM*settings.DAILY_MINUTES,
...
class GeminiPaidProRedisRotatingAPIKeyManagerSync:
    def __init__(
        ...
        redis_url: str=settings.REDIS_URL_1,
        api_keys: List[str] = settings.gemini_api_keys, 
        rpm_limit: int = settings.GEMINI_PAID_3_PRO_RATELIMITS_RPM, 
        rpd_limit: int = settings.GEMINI_PAID_3_PRO_RATELIMITS_RPD, 
        tpd_limit: int = settings.GEMINI_PAID_3_PRO_RATELIMITS_TPM*settings.DAILY_MINUTES,
